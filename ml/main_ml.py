...
from xml_to_csv		import main_xml_to_csv
...
returnValue = subprocess.call(["python object_detection\generate_tfrecord.py --csv_input=images\train_labels.csv --image_dir=images\train --output_path=train.record"])
if (returnValue == 0):
	print ("Success")
else :
	print ("Unexpected termination while creating tf records")
