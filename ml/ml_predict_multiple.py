...
def predict_multiple(img_name):
    ...
    print ("Number of detections :", len(scores[0]))
    ...
    for score in scores[0]:
        sorted_scores.append(score*100)
    ...
    imageSmall = cv2.resize(image, (960, 540))                    # Resize image

    cv2.imshow('Object detector', imageSmall)
